...
> NAT : 네트워크에서 외부망과 내부방을 나눠주는 기능을 한다. 공인망으로 나갈 때 내부망의 주소를 그대로 가져갈 수 없다. 
>
> => 주소 변환(IP주소를 변환) 
>
> => 가상머신이 사설 IP로 잡힘, 내부 접근 불가
>
>  => 외부에서 접솔할 때 따로 설정이 필요함 
>
> => **어댑터에 브리지** 로 설정 :star:
...
<figcaption>Install or upgrade an existing system <- enter </figcaption>
</figure>
</center>
...
<figcaption> 예 모든 데이터를 삭제합니다 선택 </figcaption>
</figure>
</center>
...
<figcaption> 비밀번호 입력 후 다음 </figcaption>
</figure>
</center>
